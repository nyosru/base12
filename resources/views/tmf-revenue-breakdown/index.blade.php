...
@section('external-jscss')
    ...
    @include('tmf-revenue-breakdown.css')
    @include('tmf-revenue-breakdown.js-common')
@endsection
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-9">
                                <select id="client-type-select" class="form-control">
                                    @foreach($client_type_objs as $client_type_obj)
                                        <option value="{{$client_type_obj->id}}">{{$client_type_obj->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-2">
                            ...
                            <div class="col-md-9">
                                <select id="pay-type-select" class="form-control">
                                    @foreach($pay_type_objs as $pay_type_obj)
                                        <option value="{{$pay_type_obj->id}}">{{$pay_type_obj->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row mb-2">
                            ...
                            <div class="col-md-9">
                                <select id="client-source-select" class="form-control">
                                    @foreach($client_source_objs as $client_source_obj)
                                        <option value="{{$client_source_obj->id}}">{{$client_source_obj->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <select id="boom-source-select" class="form-control">
                                    @foreach($boom_source_objs as $boom_source_obj)
                                        <option value="{{$boom_source_obj->id}}">{{$boom_source_obj->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
