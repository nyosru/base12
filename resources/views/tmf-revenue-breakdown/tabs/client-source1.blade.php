        ...
        @foreach($client_sources as $client_source)
            <tr>
                ...
                @foreach($table_th as $m_index)
                    ...
                    <td class="text-right amount" title="{{$client_source->name}}" style="white-space: nowrap" data-amount="{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['amount']:0}}">
                    ...
                    <td class="text-right amount-percent" title="{{$client_source->name}}">
                    ...
                    <td class="text-right num-percent" title="{{$client_source->name}}">
                    ...
                    <td class="text-center num-n1" title="{{$client_source->name}}" data-amount="{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['amount-n#1']:0}}">{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['n#1']:0}}</td>
                    <td class="text-center num-n2" title="{{$client_source->name}}" data-amount="{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['amount-n2+']:0}}">{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['n2+']:0}}</td>
                    <td class="text-center num-r1" title="{{$client_source->name}}" data-amount="{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['amount-r#1']:0}}">{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['r#1']:0}}</td>
                    <td class="text-center num-r2" title="{{$client_source->name}}" data-amount="{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['amount-r2+']:0}}">{{isset($data[$client_source->name][$m_index])?$data[$client_source->name][$m_index]['r2+']:0}}</td>
                    <td class="text-center num"></td>
                @endforeach
                <td class="text-right total-final amount font-weight-bold" title="{{$client_source->name}}" style="white-space: nowrap" data-amount="{{isset($total_rows[$client_source->name])?$total_rows[$client_source->name]:0}}"><span class="float-left">$</span> {{isset($total_rows[$client_source->name])?number_format($total_rows[$client_source->name],2):0}}</td>
                <td class="text-right num-percent" title="{{$client_source->name}}">{{isset($total_rows_n[$client_source->name])?number_format(100*$total_rows_n[$client_source->name]/$total_amount_n,2):0}}%</td>
                <td class="text-right total-final amount-percent" title="{{$client_source->name}}">{{isset($total_rows[$client_source->name])?number_format(100*$total_rows[$client_source->name]/$total_amount,2):0}}%</td>
                <td class="text-center total-final num-n1" title="{{$client_source->name}}"></td>
                <td class="text-center total-final num-n2" title="{{$client_source->name}}"></td>
                <td class="text-center total-final num-r1" title="{{$client_source->name}}"></td>
                <td class="text-center total-final num-r2" title="{{$client_source->name}}"></td>
                <td class="text-center total-final num" title="{{$client_source->name}}"></td>
            </tr>
        @endforeach
        <tr>
            ...
            @endforeach
            <td class="text-center total total-final amount font-weight-bold" style="white-space: nowrap" data-amount="{{$total_amount}}"><span class="float-left">$</span> {{number_format($total_amount,2)}}</td>
            <td class="text-center total total-final"></td>
