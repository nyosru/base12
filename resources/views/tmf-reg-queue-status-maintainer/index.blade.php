...
@section('modals')
    @include('tmf-reg-queue-status-maintainer.new-status-modal')
    @include('tmf-reg-queue-status-maintainer.new-sub-status-modal')
@endsection
...
@section('external-jscss')
    ...
    @include('tmf-reg-queue-status-maintainer.js')
@endsection