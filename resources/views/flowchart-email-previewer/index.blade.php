                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="alert alert-dark" role="alert">
                            <div class="row">
                                <div class="col-6"><strong>From</strong>: {{$data['from']}}</div>
                                <div class="col-6"><strong>To</strong>: {{$data['to']}}</div>
                            </div>
                            <hr/>
                            <p><strong>Subject</strong>: {{$data['subj']}}</p>
                            <hr/>
                            <p><strong>Message:</strong></p>
                            {!! explode('<div class="tsw"',$data['message'])[0] !!}
                        </div>
                    </div>
                </div>
            </div>
...
@section('external-jscss')
    ...
    @include('flowchart-email-previewer.css')
@endsection