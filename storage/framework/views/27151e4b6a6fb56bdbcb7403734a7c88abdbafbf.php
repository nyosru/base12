...
<div id="contact">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-5 col-md-5 hidden-xs col-sm-hidden col-xs-hidden padding-none
                        
                        img-block-big img-block-left" 
                style="background-image: url('<?php echo e(asset('/module_rem7/photo/enter.jpg')); ?>');">

                <?php if(1 == 2): ?>
                    <div class="feature-thumb wow fadeInRight" data-wow-delay="0.3s">
                        <div style="background-color: #8978aa; height: 100%; width:100%;">
...
<?php /**PATH /var/www/base12/data/www/site/app/Modules/Rem7/Resources/views/block-contact.blade.php ENDPATH**/ ?>