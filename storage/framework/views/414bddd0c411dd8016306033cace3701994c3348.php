<script type="text/javascript">
    ...
    function showContextMenuEvent(el, e) {
        ...
        if (tmfsales_id ==<?php echo e(\Illuminate\Support\Facades\Auth::user()->ID); ?>) {
            $('.claim-link').hide();
...
</script><?php /**PATH /var/www/html/in.trademarkfactory.com/resources/views/tmf-filing-queue-v3/js.blade.php ENDPATH**/ ?>