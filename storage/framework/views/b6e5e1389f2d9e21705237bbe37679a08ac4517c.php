            ...
            <div class="modal-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-12 text-center">
                        <label><input type="checkbox" id="show-not-in-queue" value="1"> Also show TMs that are not currently in the TM Queue</label>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-12 text-center">
...
</div><?php /**PATH /var/www/html/in.trademarkfactory.com/resources/views/tmf-filing-queue-v3/search-modal.blade.php ENDPATH**/ ?>