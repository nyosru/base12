                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-12 text-center">
                                <a href="#" id="boom-sources-link">BOOM Sources: <?php echo e(Auth::user()->sales_calls?1:count($boom_sources)+1); ?> of <?php echo e(count($boom_sources)+1); ?></a>
                            </div>
                        </div>
                        <div class="row m-4">
                            <div class="col-md-3">
...
<?php $__env->startSection('modals'); ?>
    ...
    <?php echo $__env->make('email-forms.payments-calendar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('payments-calendar.notes-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('payments-calendar.boom-sources-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('external-jscss'); ?>
    ...
    <script src="<?php echo e(asset('tinymce/js/tinymce/tinymce.min.js')); ?>" type="text/javascript"></script>

    

    <?php echo $__env->make('payments-calendar.css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script type="text/javascript">
        ...
        var today='<?php echo e($today->format('Y-m-d')); ?>';
        var current_date='<?php echo e($today->format('Y-m-d')); ?>';
        var prev_date='<?php echo e($prev_date); ?>';
        var next_date='<?php echo e($next_date); ?>';
        var calendar;
...
/*
        ...
        var c_options=<?php echo $calendar_options_json; ?>;
        ...
        $('#new-note-btn').click(function(){
            var txt="\r\n\r\n"+$('#notes').val();
            $('#notes').val(printDate() + ' <?php echo e(Auth::user()->LongID); ?>:');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/in.trademarkfactory.com/resources/views/payments-calendar/index.blade.php ENDPATH**/ ?>