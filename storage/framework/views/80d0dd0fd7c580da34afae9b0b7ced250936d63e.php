            ...
            <div class="col-4">
                <div class="card shadow-lg" id="apps-list-block">
                    <div class="accordion" id="pq-list-block">
                        ...
                        <?php if(in_array(session('current_user'),$hot_visible_for_users)): ?>
                        <div class="card">
                            ...
                            <div class="card-header" id="headingTwo">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#inprogress-tab" aria-expanded="false" aria-controls="inprogress-tab">
                                        My PQ Leads [<span id="inprogress-count"><?php echo e($inprogress_count); ?></span>]
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div class="card-header" id="headingFive">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#boomopportunities-tab" aria-expanded="false" aria-controls="boomopportunities-tab">
                                        My BOOM Opportunities [<span id="boomopportunities-count"><?php echo e($boomopportunities_count); ?></span>]
                                    </button>
                                </h2>
                            </div>
                            ...
                            <div class="card-header" id="headingThree">
                                <h2 class="mb-0">
                                    <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse" data-target="#finished-tab" aria-expanded="false" aria-controls="finished-tab">
                                        Done [<span id="finished-count"><?php echo e($finished_count); ?></span>]
                                    </button>
                                </h2>
                            </div>
...
<?php $__env->startSection('modals'); ?>
    <?php echo $__env->make('booking-applications.client-data-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('booking-applications.closer-notes-preview-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('pq-applications.call-report-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('pq-applications.email-to-client-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php echo $__env->make('pq-applications.view-as-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo $__env->make('pq-applications.edit-tmf-subject-attr-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <?php echo \App\classes\SmsSender::getModalHtml(); ?>
...
<?php $__env->startSection('external-jscss'); ?>
    ...
    <?php echo $__env->make('pq-applications.css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

    <?php echo $__env->make('pq-applications.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/in.trademarkfactory.com/resources/views/pq-applications/index-new.blade.php ENDPATH**/ ?>