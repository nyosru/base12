<?php $__currentLoopData = $tmf_reg_queue_root_status_objs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<div class="card">
    <div class="card-header d-flex align-items-center" id="root-status-<?php echo e($el->id); ?>">
        ...
        <div class="flex-shrink-1">
            <?php if($el->id==4): ?> <?php echo $__env->make('tmf-reg-queue.days-select', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php endif; ?>
        </div>
    ...
    <div id="root-status-collapse-<?php echo e($el->id); ?>" class="collapse" aria-labelledby="root-status-<?php echo e($el->id); ?>" data-parent="#root-statuses">
        <div class="card-body">
            <div class="list-group">
                <?php echo $__env->make('tmf-reg-queue.sub-statuses-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            </div>
        </div>
    </div>
</div>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php /**PATH /var/www/html/in.trademarkfactory.com/resources/views/tmf-reg-queue/root-statuses-list.blade.php ENDPATH**/ ?>