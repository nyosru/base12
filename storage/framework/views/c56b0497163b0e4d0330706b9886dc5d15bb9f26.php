...
<head>
    ...
    <meta property="vk:image" content="https://<?php echo e($HTTP_HOST); ?>/metrika/img/preview_for_vk.jpg" />
    <meta property="og:image" content="https://<?php echo e($HTTP_HOST); ?>/metrika/img/preview_for_fb.jpg" />
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.25s">
                        <p>© Copyright 2015-<?php echo e(date('Y')); ?> Все права защищены
                            <br>
...
<script src="<?php echo e(asset('/metrika/vue.js?' . date('U'))); ?>"></script>
...
<?php /**PATH /var/www/base12/data/www/site/app/Modules/Metrika/Resources/views/app/app.blade.php ENDPATH**/ ?>