                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <select class="form-control" id="lead-status" style="width: auto">
                                    <?php $__currentLoopData = \App\LeadStatus::orderBy('place_id','asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $el): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</div><!-- /.modal --><?php /**PATH /var/www/html/in.trademarkfactory.com/resources/views/booking-applications/call-report-modal.blade.php ENDPATH**/ ?>