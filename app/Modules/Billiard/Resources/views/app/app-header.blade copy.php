            ...
            <div class="row">
                        ...
                        <li class="hidden-xs">
                            <div class="welcome-msg">
                                <ul class="list-msg">
                                    ...
                                    <li>
                                        <label class="label-msg">This week</label>
                                        <a href="#">Sale special too good to miss in every gear</a>
                                    </li>

                                    <li>
                                        <label class="label-msg">Tomorrow</label>
                                        <a href="#">Laten ipsum dolor sit amet. In gravida pellen</a>
                                    </li>
                ...
                <div class="header-top-right collapsed-block col-lg-8 col-sm-12 col-md-7 col-xs-12 ">
                    ...
                    <h5 class="tabBlockTitle visible-xs">
                        More
                        <a class="expander " href="#TabBlock-1"><i class="fa fa-angle-down"></i>
                        </a>
                    </h5>
                    ...
                    <div class="tabBlock" id="TabBlock-1">
                        <ul class="top-link list-inline">
                            ...
                            @if (1 == 2)
                                ...
                                <li class="wishlist ">
                                    <a href="wishlist.html" id="wishlist-total" class="top-link-wishlist"
                                        title="Wish List (2)">
                                        <span>Wish List (2)</span>
                                    </a>
                                </li>
                                <li class="checkout hidden">
                                    <a href="checkout.html" class="top-link-checkout"
                                        title="Checkout"><span>Checkout</span></a>
                                </li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-logo col-md-3 col-sm-4 col-xs-10">
                    <a href="/index/">
                        {{-- <img src="image/demo/logos/theme_logo.png" title="Your Store" alt="Your Store" /> --}}
                        <img src="{{ asset('/billiard/image/logo.png') }}" title="В мире бильярда" alt="" />
                    </a>
                </div>
                                            ...
                                            <ul class="megamenu " data-transition="slide" data-animationtime="250">
                                                                ...
                                                                <div class="row">
                                                                        ...
                                                                        <a href="index.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-1.jpg"
                                                                                    alt="">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home2.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-2.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home3.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-3.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home4.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-4.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home5.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-5.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home6.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-6.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home7.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-7.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home8.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-8.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home9.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-9.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="home10.html" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-10.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="#" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-11.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <a href="#" class="image-link">
                                                                            <span class="thumbnail">
                                                                                <img class="img-responsive img-border"
                                                                                    src="image/demo/menu/home-12.jpg"
                                                                                    alt="">
                                                                                <span class="btn btn-default">Read
                                                                                    More</span>
                                                                            </span>
                                                ...
                                                @if (1 == 2)
                                                    <li class="with-sub-menu hover">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                            <strong><img src="image/demo/menu/hot-icon.png"
                                                                    alt="">Pages</strong>
                                                            <b class="caret"></b>
                                                        </a>
                                                ...
                                                @if (1 == 2)
                                                    <li class="with-sub-menu hover">
                                                        <p class="close-menu"></p>
                                                        <a href="#" class="clearfix">
                                                            <strong><img src="image/demo/menu/new-icon.png"
                                                ...
                                                {{-- index|uslugi|where_playing|contact --}}

                                                <li class="{{ request()->is('index*') ? 'active' : null }}">
                                                    <p class="close-menu"></p><a href="/index/" class="clearfix">
                                                        <strong>Наш салон</strong> <span class="label"></span></a>
                                                </li>

                                                <li class="{{ request()->is('shop*') ? 'active' : null }}">
                                                    <p class="close-menu"></p><a href="/shop/" class="clearfix">
                                                        <strong>Товары</strong> <span class="label"></span></a>
                                                </li>

                                                <li class="{{ request()->is('uslugi*') ? 'active' : null }}">
                                                    <p class="close-menu"></p><a href="/uslugi/" class="clearfix">
                                                        <strong>Услуги</strong> <span class="label"></span></a>
                                                </li>

                                                <li class="{{ request()->is('where_playing*') ? 'active' : null }}">
                                                    <p class="close-menu"></p><a href="/where_playing/" class="clearfix">
                                                        <strong>Где поиграть в Тюмени</strong> <span
                                                            class="label"></span></a>
                                                </li>

                                                <li class="{{ request()->is('contact*') ? 'active' : null }}">
                                                    <p class="close-menu"></p><a href="/contact/" class="clearfix">
                                                        <strong>Контакты</strong> <span class="label"></span></a>
                                                </li>
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <div class="col-sm-4">
                                                                                <div class="row img-banner">
                                                                                    <a href="#"><img
                                                                                            src="image/demo/cms/img-static-megamenu-h.png"
                                                                                            alt="banner"></a>
                                                                                </div>
                                                                            </div>
                                                                        </div>
