...
class Line7HistorySnapshotDataLoader extends Line5HistorySnapshotDataLoader
{

    protected function initData()
    {
        $this->calculateValue(31);
    }
    ...
    public function showDetails()
    {
        ...
        return view('ops-trends.details.line5',compact('data','table_header_template','dashboard_in_timings_type_objs'));
    }
