...
class Line19HistorySnapshotDataLoader extends Line5HistorySnapshotDataLoader
{

    protected function initData()
    {
        $this->calculateValue(43);
    }

    public function loadHistoryValue(){
        $cipostatus_status_formalized_id=5;
    ...
    public function showDetails()
    {
        ...
        $table_header_template='ops-trends.details.line19-header';
