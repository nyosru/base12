...
//        dd($tmoffers);
//        exit;
//        $tmoffers=Tmoffer::whereIn('ID',[42365])->get();
        $ec_id=3;
...
//                            dd($data);
//                echo $data['client_fn'].' '.$data['email'].'<br/>';exit;
                try {
